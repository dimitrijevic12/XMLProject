...
export const GET_CAMPAIGNS_FOR_CLIENT = "getCampaignsForClient";
export const GET_CAMPAIGNS_FOR_CLIENT_ERROR = "getCampaignsForClientError";
export const GET_STORIES_FOR_CAMPAIGN = "getStoriesForCampaign";
