...
{
    public class RecurringPostCampaignAdaptee
    {
        /* public RecurringPostCampaign ConvertSqlDataReaderToReccuringStoryCampaign(DataRow dataRow)
         {
             return RecurringPostCampaign.Create(
