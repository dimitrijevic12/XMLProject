...
{
    public class PostSingleAdaptee
    {
        public PostSingle ConvertSqlDataReaderToPostSingle(DataRow dataRow)
        {
            return PostSingle.Create(
                ...
                contentPath: ContentPath.Create(dataRow[14].ToString().Trim()).Value).Value;
        }
    }
}